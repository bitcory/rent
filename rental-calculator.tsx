...
const RentalCalculator: React.FC = () => {
  ...
  // 할인률 선택 핸들러
  const handleDiscountRateSelect = (period: number, value: number) => {
    setDiscountRates({
      ...discountRates,
      [period]: value
    });
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex">
      ...
      <div className="flex-1 p-6 overflow-auto">
        <div className="max-w-5xl mx-auto bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-gray-700">
